...
const filesToPreCache = [
    // Web pages
    { url: '/', revision: '2020-08-10-1' },
    { url: '/acercade/', revision: '2020-08-10-1' },
    { url: '/chat/', revision: '2020-08-10-1' },
    { url: '/chat/admin/', revision: '2020-08-10-1' },
    { url: '/chat/home/', revision: '2020-08-10-1' },
    { url: '/login/', revision: '2020-08-10-1' },
    { url: '/politicaprivacidad/', revision: '2020-08-10-1' },
    { url: '/terminosdelservicio/', revision: '2020-08-10-1' },
    // Images
    ...
    { url: '/static/media/audio/call_ended.mp3', revision: '2020-08-10-1' },
    { url: '/static/media/audio/calling_ring.mp3', revision: '2020-08-10-1' }
];
