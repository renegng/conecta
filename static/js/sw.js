...
const filesToPreCache = [
    ...
    { url: '/autocuidado/', revision: '2020-09-25-1' },
    { url: '/dirservicios/', revision: '2020-09-25-1' },
    { url: '/login/', revision: '2020-09-25-1' },
    { url: '/materialesedu/', revision: '2020-09-25-1' },
    { url: '/planseguridad/', revision: '2020-09-25-1' },
    { url: '/politicaprivacidad/', revision: '2020-09-25-1' },
    { url: '/sobrenosotros/', revision: '2020-09-25-1' },
    { url: '/terminosdelservicio/', revision: '2020-09-25-1' },
    { url: '/welcome/', revision: '2020-09-25-1' },
    // Images
    ...
    { url: '/static/images/manifest/conatel.png', revision: '2020-09-25-1' },
    ...
    { url: '/static/images/manifest/user_f_01.svg', revision: '2020-09-25-1' },
    { url: '/static/images/manifest/user_f_02.svg', revision: '2020-09-25-1' },
    { url: '/static/images/manifest/user_f_03.svg', revision: '2020-09-25-1' },
